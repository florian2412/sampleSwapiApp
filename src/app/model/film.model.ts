export class FilmModel {
  ...
  producer: string; // The name(s) of the producer(s) of this film. Comma seperated.
  ...
  edited: string; //he ISO 8601 date format of the time that this resource was edited.
}
