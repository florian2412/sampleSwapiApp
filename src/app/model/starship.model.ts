export class StarshipModel {
  ...
  manufacturer: string; // The manufacturer of this starship. Comma seperated if more than one.
  ...
  max_atmosphering_speed: string; // The maximum speed of this starship in atmosphere. "N/A" if this starship is incapable of atmosphering flight.
